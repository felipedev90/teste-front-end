...
- **SASS com BEM:** SASS é o pré-processador mais utilizado no mercado de e-commerce. BEM garante organização e escalabilidade do CSS.
...
- **Husky + lint-staged:** Garantem que nenhum código com erro de lint ou tipagem chegue ao repositório.
